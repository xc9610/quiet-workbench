...
const GENERIC_WIDGETS: RegisteredWidgetDefinition[] = [
  ...
  { id: "view.heatmap", title: "热力图", description: "按天展示最近一年的笔记活动", surfaces: ["workbench"], pack: "core", refresh: "live", defaultSize: { width: 12, height: 4 }, libraryCategory: "view", validateConfig: validateGenericConfig },
